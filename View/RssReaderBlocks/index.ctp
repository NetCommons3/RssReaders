...
<div class="modal-body">
	...
	<div class="tab-content">
		...
		<div id="nc-rss_readers-setting-<?php echo $frameId; ?>">
				...
				<table class="table table-hover">
					...
					<tbody>
						<?php foreach ($rssReaders as $rssReader) : ?>
							<tr<?php echo ($blockId === $rssReader['block']['id'] ? ' class="active"' : ''); ?>>
								<td>
									<?php echo $this->Form->input('Frame.block_id',
										array(
											'type' => 'radio',
											'name' => 'data[Frame][block_id]',
											'options' => array((int)$rssReader['block']['id'] => ''),
											'div' => false,
											'legend' => false,
											'label' => false,
											'hiddenField' => false,
											'checked' => (int)$rssReader['block']['id'] === (int)$blockId,
											'onclick' => 'submit()'
										)); ?>
								</td>
								<td>
								...
								<td>
									<?php echo $this->Date->dateFormat($rssReader['rssReader']['modified']); ?>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
